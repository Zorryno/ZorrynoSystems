...
public final class Main extends JavaPlugin {
    ...
    private void consoleMessage() {
        getLogger().info("\n" + ChatColor.GRAY + "|" +
                ...
                ChatColor.DARK_GREEN +  "                      / ____|         | |            " + ChatColor.DARK_RED +       "                       /_/ / /_/ / / __ \\  " + ChatColor.GRAY + "|\n" + ChatColor.GRAY + "|" +
                ChatColor.DARK_GREEN +  "                     | (___  _   _ ___| |_ ___ _ __ ___  ___        " + ChatColor.DARK_RED +       "            \\____/ / / / /  " + ChatColor.GRAY + "|\n" + ChatColor.GRAY + "|" +
                ChatColor.DARK_GREEN +  "                      \\___ \\| | | / __| __/ _ \\ '_ ` _ \\/ __|       " + ChatColor.DARK_RED +   "                  /_/ /_/   " + ChatColor.GRAY + "|\n" + ChatColor.GRAY + "|" +
                ChatColor.DARK_GREEN +  "                      ____) | |_| \\__ \\ ||  __/ | | | | \\__ \\       " + ChatColor.DARK_RED +   "                            " + ChatColor.GRAY + "|\n" + ChatColor.GRAY + "|" +
                ChatColor.DARK_GREEN +  "                     |_____/ \\__, |___/\\__\\___|_| |_| |_|___/       " + ChatColor.DARK_RED +    "                            " + ChatColor.GRAY + "|\n" + ChatColor.GRAY + "|" +
                ChatColor.DARK_GREEN +  "                              __/ |                                 " + ChatColor.DARK_RED +       "                            " + ChatColor.GRAY + "|\n" + ChatColor.GRAY + "|" +
                ChatColor.DARK_GREEN +  "                             |___/                                  " + ChatColor.DARK_RED +       "                            " + ChatColor.GRAY + "|\n" + ChatColor.GRAY + "|" +
                ChatColor.GRAY +        "                                                                    " + ChatColor.DARK_RED +       "                            " + ChatColor.GRAY + "|\n" + ChatColor.GRAY + "|" +
                ChatColor.GREEN +       "                                     Zorryno Systems " + ChatColor.DARK_RED +       "erfolgreich geladen!                    1.2" + ChatColor.GRAY + "|\n" + ChatColor.GRAY + "|" +
                ChatColor.GRAY +        " -------------------------------------------------------------------" + ChatColor.GRAY +           "-------------------------------------------" + ChatColor.GRAY + "|");
    }
}
